...
// The true color pels
   ...
   private static final int LAST_BYTE = 0x00FF;
...
*/
   ...
   public int swapShort(int v)
      {
      return  ((v << 8) & 0xFF00) | ((v >> 8) & LAST_BYTE);
      }
/*
 ...
 */
   public RgbQuad pelToRGBQ(int pel)
      ...
      rgbq.blue     =  pel        & LAST_BYTE;
      rgbq.green    = (pel >> 8)  & LAST_BYTE;
      rgbq.red      = (pel >> 16) & LAST_BYTE;
      rgbq.reserved = (pel >> 24) & LAST_BYTE;
 ...
 */
   public RgbQuad pelToRGB(int pel)
      ...
      rgb.blue  =  pel        & LAST_BYTE;
      rgb.green = (pel >> 8)  & LAST_BYTE;
      rgb.red   = (pel >> 16) & LAST_BYTE;
...
//            System.out.printf("\n");
         ...
         return imageArray;
      } // public static void bmpToImageArrays
...
// there is no color table for this true color image, so write out the pels
            ...
            for (int i = bmpInfoHeader_biHeight - 1; i >= 0; --i)    // write over the rows (in the usual inverted format)
            {
               ...
               {
                  pel = imageArray[i][j];
                  rgbQuad_rgbBlue  = pel & LAST_BYTE;
                  rgbQuad_rgbGreen = (pel >> 8)  & LAST_BYTE;
                  rgbQuad_rgbRed   = (pel >> 16) & LAST_BYTE;
      ...
      } // public static void imageArrayToBMP
   } // public class DibDump
